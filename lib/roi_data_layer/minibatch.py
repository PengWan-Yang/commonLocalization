...
def get_minibatch(roidb, phase='train', step_frame=1, length_support=768):
    ...
    video_blob = _get_video_blob(roidb, random_scale_inds, phase=phase, step_frame=step_frame, length_support=length_support)

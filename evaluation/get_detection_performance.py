...
from eval_detection_vi import ANETdetection
...
def parse_input():
    ...
    p.add_argument('--ground_truth_filename', default='./data/test_gt_1step_20_10_90.json',
                   help='Full path to json file containing the ground truth.')
    p.add_argument('--prediction_filename', default='./data/test_pred_1step_20_10_90.json',
